...
bool32 jnui_getLabelIsTranslucent(int elementIdx, const jnui_bnll_res_t* bnll, jnui_layout_element_t* layoutElements,
								 const jnui_bncl_res_t* bncl);
void jnui_setLabelIsTranslucent(int elementIdx, bool32 translucent, const jnui_bnll_res_t* bnll,
