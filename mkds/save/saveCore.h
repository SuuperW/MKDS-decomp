...
typedef struct
{
	...
	bool32 readBlockIsHeader;
	u32 field3C;
	u8* writeSrc;
	u32 writeDst;
	u32 writeLength;
	u32 field4C;
	bool32 writeBlockIsHeader;
	void* callbackArg;
	u32 field58;
	u32 field5C;
	void* tmpBuf;
...
bool32 savc_readBlock(u32 src, u8* dst, u32 length, savc_transfer_callback_t callback, u32 blockMagic);
bool32 savc_readWithBackup(u32 src, u32 backupSrc, u8* dst, u32 length, savc_transfer_callback_t callback, u32 blockMagic,
	bool32 isHeader);
bool32 savc_writeWithBackup(u32 dst, u32 backupDst, u8* src, u32 length, savc_transfer_callback_t callback, bool32 isHeader);
bool32 savc_writeBlock(u32 dst, u8* src, u32 length, savc_transfer_callback_t callback);

static inline bool32 savc_isEnabled()
{
	return gSaveCore->isEnabled;
}

static inline bool32 savc_isBusy()
{
