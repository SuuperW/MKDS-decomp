...
typedef bool32 (*mgcnt_try_steal_balloon_func_t)(u16 driverId1, u16 driverId2);
typedef void (*mgcnt_field384_func_t)(u16 driverId1, u16 driverId2);
typedef bool32 (*mgcnt_on_damage_func_t)(u16 driverId1, u16 driverId2);
...
void mgcnt_setDriverIsInflating(u16 driverId, bool32 isInflating);
bool32 mgcnt_getDriverIsInflating(u16 driverId);
void mgcnt_applyForceToDriverBalloons(u16 driverId, const VecFx32* force);
bool32 mgcnt_handleDriverDriverCollide(u16 driverId1, u16 driverId2);
...
bool32 mgcnt_hasWinnerBeenDecided();
...
bool32 mgcnt_isDriverDead(u16 driverId);
bool32 mgcnt_isDriverShineCountLow(u16 driverId);
bool32 mgcnt_hasDriverWon(u16 driverId);
