...
bool32 arc_readFileToEnd(const char* path, void* dst, u32 maxLen);
bool32 arc_readFile(const char* path, void* dst, u32 len);
...
void sub_20472A8();
void arc_2047274();
bool32 arc_isCourseTexAvailable();
...
static inline bool32 arc_isArchiveLoaded(MKDSArchive arcId)
{
	return gArcData->arcs[arcId].loaded;
}

// static inline void arc_setSomethingFlag29(arc_something_t* something, bool32 flag29)
// {
//     something->flags = (something->flags & ~0x20000000) | ((flag29 & 1) << 29);
// }

// static inline void arc_setSomethingFlag30(arc_something_t* something, bool32 flag30)
// {
//     something->flags = (something->flags & ~0x40000000) | ((flag30 & 1) << 30);
// }

// static inline void arc_setSomethingFlag31(arc_something_t* something, bool32 flag31)
// {
