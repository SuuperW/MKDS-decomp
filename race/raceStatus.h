...
typedef struct
{
	...
	bool32 resultsStored;
	bool32 camAnimComplete;
...
bool32 rstat_hasDriverFinished(u16 driverId);
...
bool32 rstat_getUncontrollable();
...
bool32 rstat_isMrWinDelayOver();
bool32 rstat_203C0BC();
