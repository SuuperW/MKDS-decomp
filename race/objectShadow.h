...
void oshd_render(objshadow_t* objShadow, fx32* scale, const Orientation* camMtx, u16 alpha);
void oshd_renderMat(objshadow_t* objShadow, fx32* scale, const Orientation* camMtx, u16 alpha);
void oshd_renderJgShadowTransformed(const VecFx32* scale, const Orientation* mtx, u16 alpha, u16 maxAlpha);
