...
bool32 spa_uploadTextures(spa_particleset_t* pset, u32 (*texVramAllocFunc)(u32 szByte, bool32 is4x4comp));
bool32 spa_uploadPalettes(spa_particleset_t* pset, u32 (*plttVramAllocFunc)(u32 szByte, bool32 is4pltt));
bool32 spa_defaultUploadTextures(spa_particleset_t* pset);
