...
void dc_setBg0Config(display_config_engine_t* bgConfig, int priority, bool32 mosaic, GXBGScrSizeText screenSize,
					 GXBGColorMode colorMode, GXBGScrBase screenBase, GXBGCharBase charBase, GXBGExtPltt extPlttSlot);
void dc_setBg1Config(display_config_engine_t* bgConfig, int priority, bool32 mosaic, GXBGScrSizeText screenSize,
					 GXBGColorMode colorMode, GXBGScrBase screenBase, GXBGCharBase charBase, GXBGExtPltt extPlttSlot);
void dc_setBg2Config(display_config_engine_t* bgConfig, int priority, bool32 mosaic, GXBGScrSizeText screenSize,
					 GXBGColorMode colorMode, GXBGScrBase screenBase, GXBGCharBase charBase);
void dc_setBg3Config(display_config_engine_t* bgConfig, int priority, bool32 mosaic, GXBGScrSizeText screenSize,
					 GXBGColorMode colorMode, GXBGScrBase screenBase, GXBGCharBase charBase);
void dc_setBg2ConfigDcBmp(display_config_engine_t* bgConfig, int priority, bool32 mosaic, GXBGScrSizeDcBmp screenSize,
...
bool32 dc_wasFrameTimeExceeded(void);
void dc_notifyVBlank(void);
void dc_2037658(bool32 a1);
void dc_2037498(bool32 a1);
void dc_handleEndOfFrame(void);

void dc_fadeInSingle(s16 frameCount, bool32 main);
void dc_fadeIn(s16 frameCount);
void dc_fadeFromBlackSingle(s16 frameCount, bool32 main);
void dc_fadeFromBlack(s16 frameCount);
void dc_fadeToBlackSingle(s16 frameCount, bool32 main);
void dc_fadeToBlack(s16 frameCount);
void dc_fadeToWhiteSingle(s16 frameCount, bool32 main);
void dc_fadeToWhite(s16 frameCount);
bool32 dc_isFadedOut(void);
void dc_resetFade(void);
bool32 dc_isFadedIn(void);

static inline void dc_setMainBg0Config(display_config_t* displayConfig, int priority, bool32 mosaic,
...
static inline void dc_setMainBg1Config(display_config_t* displayConfig, int priority, bool32 mosaic,
									   GXBGScrSizeText screenSize, GXBGColorMode colorMode, GXBGScrBase screenBase,
									   GXBGCharBase charBase, GXBGExtPltt extPlttSlot)
{
...
static inline void dc_setMainBg2Config(display_config_t* displayConfig, int priority, bool32 mosaic,
									   GXBGScrSizeText screenSize, GXBGColorMode colorMode, GXBGScrBase screenBase,
...
static inline void dc_setMainBg3Config(display_config_t* displayConfig, int priority, bool32 mosaic,
									   GXBGScrSizeText screenSize, GXBGColorMode colorMode, GXBGScrBase screenBase,
									   GXBGCharBase charBase)
{
...
static inline void dc_setMainBg2ConfigDcBmp(display_config_t* displayConfig, int priority, bool32 mosaic,
...
static inline void dc_setSubBg0Config(display_config_t* displayConfig, int priority, bool32 mosaic,
									  GXBGScrSizeText screenSize, GXBGColorMode colorMode, GXBGScrBase screenBase,
									  GXBGCharBase charBase, GXBGExtPltt extPlttSlot)
{
...
static inline void dc_setSubBg1Config(display_config_t* displayConfig, int priority, bool32 mosaic,
									  GXBGScrSizeText screenSize, GXBGColorMode colorMode, GXBGScrBase screenBase,
									  GXBGCharBase charBase, GXBGExtPltt extPlttSlot)
{
...
static inline void dc_setSubBg2Config(display_config_t* displayConfig, int priority, bool32 mosaic,
									  GXBGScrSizeText screenSize, GXBGColorMode colorMode, GXBGScrBase screenBase,
									  GXBGCharBase charBase)
{
...
static inline void dc_setSubBg3Config(display_config_t* displayConfig, int priority, bool32 mosaic,
									  GXBGScrSizeText screenSize, GXBGColorMode colorMode, GXBGScrBase screenBase,
									  GXBGCharBase charBase)
{
...
static inline void dc_setSubBg2ConfigDcBmp(display_config_t* displayConfig, int priority, bool32 mosaic,
										   GXBGScrSizeDcBmp screenSize, GXBGAreaOver areaOverMode,
										   GXBGScrBase screenBase)
{
