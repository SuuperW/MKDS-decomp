...
typedef struct
{
	...
	u16 logicPartCount;
	u32 field178;
	bool32 hasKoopaBlock;
	bool32 hasRotatingCylinder;
	bool32 hasBridge;
	bool32 hasWall;
...
bool32 mobj_sphereCollide(const VecFx32* position, fx32 sphereSize, mobj_inst_t* instance, VecFx32* pushback);
bool32 mobj_getHasWater();
fx32 mobj_getWaterPlaneDistance2(fx32 y);
fx32 mobj_getWaterTideProgress();
u16 mobj_getWaterTidePhase();
bool32 mobj_getHasDiveableWater();
fx32 mobj_getWaterPlaneDistance1(fx32 y);
bool32 mobj_20D3D10(fx32 y);
