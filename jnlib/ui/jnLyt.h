...
bool32 jnui_getCellIsTranslucent(int elementIdx, const NNSG2dCellDataBank* cellDataBank, const jnui_bncl_res_t* bncl);
void jnui_setCellIsTranslucent(int elementIdx, bool32 translucent, const NNSG2dCellDataBank* cellDataBank,
