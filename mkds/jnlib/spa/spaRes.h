...
static_assert(sizeof(spa_res_emitter_t) == 0x58);
...
static_assert(sizeof(spa_res_emitter_scaleanim_t) == 0xC);
...
static_assert(sizeof(spa_res_emitter_coloranim_t) == 0xC);
...
static_assert(sizeof(spa_res_emitter_alphaanim_t) == 8);
...
static_assert(sizeof(spa_res_emitter_texanim_t) == 0xC);
...
static_assert(sizeof(spa_res_emitter_child_t) == 0x14);
...
static_assert(sizeof(spa_res_emitter_field_gravity_t) == 8);
...
static_assert(sizeof(spa_res_emitter_field_random_t) == 8);
...
static_assert(sizeof(spa_res_emitter_field_magnet_t) == 0x10);
...
static_assert(sizeof(spa_res_emitter_field_spin_t) == 4);
...
static_assert(sizeof(spa_res_emitter_field_collision_t) == 8);
...
static_assert(sizeof(spa_res_emitter_field_convergence_t) == 0x10);
...
static_assert(sizeof(spa_res_texture_t) == 0x20);
