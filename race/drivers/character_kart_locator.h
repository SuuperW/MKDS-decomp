...
void cklcr_setLoadFromFolder(bool32 loadFromFolder);
const char* cklcr_getCharacterNsbmdPath(CharacterId character, bool32 isPlayer);
const char* cklcr_getCharacterNsbtxPath(CharacterId character, bool32 isPlayer);
...
const char* cklcr_getCharacterModelName(CharacterId character, bool32 isPlayer);
