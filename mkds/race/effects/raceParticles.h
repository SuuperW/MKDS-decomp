...
typedef struct
{
	...
	bool32 (*func)(const rptc_col_effect_variant_t* variant, int a2, racerData* driver);
	u32 field1C;
} rptc_col_effect_t;
...
void rptc_collisionParticleRender(u16 collisionEffect, racerData* driver);
...
void rptc_killDriverEffects_copy(racerData* driver);
...
void rptc_startSlipstreamEffect(racerData* driver);
void rptc_stopSlipstreamEffect(racerData* driver);
void rptc_startSlipstreamBeginEffect(racerData* driver);
void rptc_stopSlipstreamBeginEffect(racerData* driver);
...
void rptc_startBoostEffect(int type, racerData* driver);
