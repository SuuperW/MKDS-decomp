...
bool32 snd_loadCharacterSounds(u16 mask);
...
void snd_init(void* staticHeap, u32 staticHeapSize, bool32 isNormalBoot);
void snd_main(void);
...
bool32 sub_2105504(void);
bool32 race_isBossBattle(void);
